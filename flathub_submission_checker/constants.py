...
COMMENT_FOOTER = (
    ...
    "I run hourly to manage submission PRs and I can also be triggered "
    "with the <code>/review</code> command. If you would like me "
    "to ignore a PR, please add the "
    "<code>leave-open</code> label to it.</sub>"
)
